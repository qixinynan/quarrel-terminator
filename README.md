...
1. **克隆项目**
```bash
git clone https://github.com/Nakuouo/quarrel-terminator.git
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Nakuouo/quarrel-terminator)
